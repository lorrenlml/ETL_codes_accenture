...
python ConvertFixedToDelimiter.py -i ODATE_20210507_UESWCFD20159DW01.UESWCFD20159DWFW.I22L.20210507.221332.231409.IN -c field_len.csv -d "|"
...
# Read the Config File  and store the field names and field length in a list
...
with open(OutputFile, 'w') as f1:
    ...
    with open(InputFile, 'r') as f:
        for line in f:
            ...
            for r in rec:
                rec2.append(r.lstrip().rstrip()) 
            # Remove head and trail rows 
            if rec2[0] == '000' or rec2[0] == '999':
                continue
            else:
                myLine = DELIMITER.join(map(str, rec2))
                f1.write(myLine + "\n")